    ...
    if (parseInt(wtCount.rows[0].count) === 0) {
      const workTypes = [
        ...
        },
        {
          ...
          slug: 'gardening',
          description: 'Lawn mowing, hedge trimming, and green waste removal.',
          category: 'gardening',
          duration: 90,
          price: 40.00,
          is_active: true,
        ...
        },
        {
          ...
          name: 'House Moving',
          slug: 'removalist',
          description: 'Complete home relocation - we handle everything with care.',
          category: 'removalist',
          duration: 180,
          price: 80.00,
          is_active: true,
