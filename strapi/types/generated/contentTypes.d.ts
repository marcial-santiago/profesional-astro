...
export interface ApiAvailabilityAvailability
  ...
  info: {
    description: 'Weekly recurring availability slots for scheduling';
...
export interface ApiBlockedDateBlockedDate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Dates when services are unavailable (holidays, maintenance, etc.)';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles with rich text content and hero images';
...
export interface ApiVisitVisit extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Scheduled visits/appointments booked by clients';
    displayName: 'Visit';
    pluralName: 'visits';
    singularName: 'visit';
  };
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workType: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiWorkTypeWorkType extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Types of work/services offered (cleaning, plumbing, construction)';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['cleaning', 'plumbing', 'construction']
    > &
      Schema.Attribute.Required &
